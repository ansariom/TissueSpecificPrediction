...
batch_size = 100
display_step = 50
weight_decays = np.arange(0.00001, max_param ,0.01) 
fold = 0
fold_results = []
outdir = "-"
...
#     print(mean_param)
    ...
    for key, group in grouped:
        group.plot(ax=ax, kind='line', x='param', y='auc', label=key, color=colors[key], xlim = [0, 0.8], ylim = [0.4, 1])
...
if __name__ == "__main__":
    ...
    seeds = np.random.randint(120000, size = 5)
